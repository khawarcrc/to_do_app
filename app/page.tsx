...
function NavDropdown({ label, badge, children, open, onToggle, onClose }: DropdownProps) {
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          width: '80vw',
          height: '60vh',
          background: 'radial-gradient(ellipse at center, rgba(12,102,228,0.12) 0%, transparent 70%)',
          pointerEvents: 'none',
          zIndex: 0,
        }}
      />
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
            ...
            <NavDropdown
              label="Static"
              open={staticOpen}
              onToggle={() => { setStaticOpen((p) => !p); setDynamicOpen(false); }}
              onClose={() => setStaticOpen(false)}
            >
              {STATIC_LINKS.length === 0 ? (
                <div style={{ padding: '20px 16px', textAlign: 'center' }}>
                  <div style={{ fontSize: '22px', marginBottom: '6px' }}>🚧</div>
                  <div style={{ fontSize: '12.5px', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '2px' }}>
                    Coming soon
                  </div>
            ...
            <NavDropdown
              ...
              open={dynamicOpen}
              onToggle={() => { setDynamicOpen((p) => !p); setStaticOpen(false); }}
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div style={{ fontSize: '10px', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--text-muted)', padding: '6px 8px 4px' }}>
              Static
            </div>
            {STATIC_LINKS.length === 0 ? (
              <div style={{ padding: '8px', fontSize: '12.5px', color: 'var(--text-muted)', fontStyle: 'italic' }}>
            ...
            <div style={{ fontSize: '10px', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--text-muted)', padding: '2px 8px 4px' }}>
              Dynamic
            </div>
            ...
            >
              <div
                style={{
                  width: '32px', height: '32px', borderRadius: '8px',
                  backgroundColor: 'rgba(239,68,68,0.08)', display: 'flex',
                  alignItems: 'center', justifyContent: 'center', flexShrink: 0,
                }}
              >
        ...
        <section
          style={{
            maxWidth: '900px',
            margin: '0 auto',
            padding: 'clamp(4rem, 10vw, 8rem) clamp(1.5rem, 5vw, 4rem) clamp(2rem, 6vw, 4rem)',
            textAlign: 'center',
          }}
        >
          {/* Greeting badge */}
          ...
          >
            Manage tasks, capture insights, and build the habit of intentional daily progress.
          </p>
          ...
          >
            ...
            <Link href="/app" style={{ textDecoration: 'none' }}>
              ...
              >
                ...
                <h3 style={{ fontSize: '1.05rem', fontWeight: 700, margin: '0 0 8px', color: 'var(--text-primary)' }}>
                  Task Manager
                </h3>
                <p style={{ fontSize: '13.5px', color: 'var(--text-muted)', lineHeight: 1.6, margin: 0 }}>
                  Kanban board, list view and calendar. Full CRUD, priorities, tags, subtasks and time tracking.
                </p>
                <div
                  style={{
                    marginTop: '20px',
            ...
            <Link href="/quotes" style={{ textDecoration: 'none' }}>
              ...
              >
                ...
                <p style={{ fontSize: '13.5px', color: 'var(--text-muted)', lineHeight: 1.6, margin: 0 }}>
                  Capture daily quotes, life lessons and things to remember. Three columns to keep wisdom organized.
                </p>
                <div
                  style={{
                    marginTop: '20px',
        ...
        <section
          style={{
            maxWidth: '900px',
            margin: '0 auto',
            padding: 'clamp(1rem, 3vw, 2rem) clamp(1.5rem, 5vw, 4rem) clamp(3rem, 8vw, 6rem)',
          }}
        >
          <p
            style={{
        ...
        >
          <span style={{ fontSize: '12px', color: 'var(--text-muted)' }}>
            © {new Date().getFullYear()} TodoFlow. Built with Next.js &amp; MongoDB Atlas.
          </span>
          <div style={{ display: 'flex', gap: '16px' }}>
            <Link href="/app" style={{ fontSize: '12px', color: 'var(--text-muted)', textDecoration: 'none' }}>
              Task Manager
            </Link>
            <Link href="/quotes" style={{ fontSize: '12px', color: 'var(--text-muted)', textDecoration: 'none' }}>
              Quotes
            </Link>
